...
while True:
    user = api.get_user('Manas_02001')
    api.update_profile(name=f'MANAS|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : MANAS|{follower_count(user)} Followers')
